 ...
 * исключению Если ничего не найдено - идет поиск хэндлера для всех исключений по данной команде Далее идет поиск
 * хэндлера, который обрабатывает исключение вне зависимости от типа команды
 */
